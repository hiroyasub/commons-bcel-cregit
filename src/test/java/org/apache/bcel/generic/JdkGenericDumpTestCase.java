...
return|;
block|}
comment|/**      * Used from {@code @MethodSource}      *      * @return a stream of Java homes.      */
specifier|public
specifier|static
name|Stream
argument_list|<
...
name|JdkGenericDumpTestCase
operator|::
name|getAllJavaHomesOnWindows
argument_list|)
argument_list|,
name|getAllJavaHomesFromHomesKey
argument_list|(
name|EXTRA_JAVA_HOMES
argument_list|)
argument_list|)
...
argument_list|)
argument_list|,
name|getAllJavaHomesFromRootKey
argument_list|(
name|EXTRA_JAVA_ROOT
argument_list|)
argument_list|)

...
begin_comment
comment|/**   * This class is derived from the abstract   *<A HREF="org.apache.commons.bcel6.classfile.Constant.html">Constant</A> class   * and represents a reference to the name and signature  * of a field or method.  *  * @version $Id$  * @author<A HREF="mailto:m.dahm@gmx.de">M. Dahm</A>  * @see     Constant  */
end_comment

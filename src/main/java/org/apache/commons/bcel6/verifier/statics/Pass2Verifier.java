...
begin_comment
comment|/**  * This PassVerifier verifies a class file according to  * pass 2 as described in The Java Virtual Machine  * Specification, 2nd edition.  * More detailed information is to be found at the do_verify()  * method's documentation.  *  * @version $Id$  * @author Enver Haase  * @see #do_verify()  */
end_comment
...
name|class
expr_stmt|;
comment|/*             CONST_Fieldref = org.apache.commons.bcel6.classfile.ConstantFieldref.class;             CONST_Methodref = org.apache.commons.bcel6.classfile.ConstantMethodref.class;             CONST_InterfaceMethodref = org.apache.commons.bcel6.classfile.ConstantInterfaceMethodref.class;             */
name|CONST_String
operator|=
name|org
operator|.
...
block|}
block|}
comment|// Nearly forgot this! Funny return values are allowed, but a non-empty arguments list makes a different method out of it!
if|if
condition|(
name|name
operator|.

...
return|;
block|}
comment|/**      * This overrides the deprecated version as we know here that the referenced class      * cannot be an array unless something has gone badly wrong.      * @return name of the referenced class/interface      * @throws IllegalArgumentException if the referenced class is an array (this should not happen)      */
annotation|@
name|Override
specifier|public
name|String

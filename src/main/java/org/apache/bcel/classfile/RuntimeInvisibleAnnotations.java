...
begin_comment
comment|/**  * represents an annotation that is represented in the class file but is not  * provided to the JVM.  *  * @version $Id: RuntimeInvisibleAnnotations  * @since 6.0  */
end_comment

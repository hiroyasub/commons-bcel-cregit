...
begin_comment
comment|/**  * Unknown (non-standard) attributes may be read via user-defined factory  * objects that can be registered with the Attribute.addAttributeReader  * method. These factory objects should implement this interface.   * @see Attribute  * @version $Id$  * @author<A HREF="mailto:m.dahm@gmx.de">M. Dahm</A>  *   * @deprecated Use UnknownAttributeReader instead   */
end_comment

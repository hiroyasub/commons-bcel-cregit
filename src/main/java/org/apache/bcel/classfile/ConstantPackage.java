...
begin_comment
comment|/**  * This class is derived from the abstract {@link Constant} and represents a reference to a package.  *  *<p>  * Note: Early access Java 9 support- currently subject to change  *</p>  *  * @see Constant  * @since 6.1  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * Dump constant package to file stream in binary format.      *      * @param file Output file stream      * @throws IOException if an I/O error occurs.      */
annotation|@
name|Override
specifier|public
name|void
...
return|;
block|}
comment|/**      * @param nameIndex the name index in the constant pool of this Constant Package      */
specifier|public
name|void
name|setNameIndex
parameter_list|(

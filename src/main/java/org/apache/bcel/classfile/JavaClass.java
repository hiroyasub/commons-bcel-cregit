...
return|;
block|}
comment|/**      * @return file name where this class was read from      */
specifier|public
name|String
name|getSourceFileName
parameter_list|()
...
return|;
block|}
comment|/**      * Gets the source file path including the package path.      *      * @return path to original source file of parsed class, relative to original source directory.      * @since 6.7.0      */
specifier|public
name|String

...
argument_list|)
operator|+
literal|"' has superfluous access modifier(s) set: everything but ACC_STRICT is ignored."
argument_list|)
expr_stmt|;
block|}
if|if
...
argument_list|)
operator|+
literal|"' must not be abstract. This contradicts the Java Language Specification, Second Edition (which omits this constraint) but is common practice of existing verifiers."
argument_list|)
throw|;
block|}
block|}

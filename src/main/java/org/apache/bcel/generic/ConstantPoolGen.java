...
parameter_list|()
block|{
comment|// 3 extra spaces are needed as some entries may take 3 slots
if|if
condition|(
name|index
operator|+
...
argument_list|(
literal|"The number of constants "
operator|+
operator|(
name|index
operator|+
...
operator|)
operator|+
literal|" is over the size of the constant pool: "
operator|+
name|Const
operator|.
name|MAX_CP_ENTRIES
...
literal|2
expr_stmt|;
comment|// the constant array shall not exceed the size of the constant pool
name|size
operator|=
name|Math
operator|.

...
expr_stmt|;
block|}
comment|/**      * Override the parent method because our class name is held elsewhere.      *      * Note: Contrary to this method's name it does not return the class name of the invoke target; rather it returns the      * name of the method that will be used to invoke the Lambda method generated by this invoke dynamic instruction.      */
annotation|@
name|Override
specifier|public
name|String

...
begin_comment
comment|/**  * Implement this interface if you're interested in changes to a MethodGen object  * and register yourself with addObserver().  *  * @version $Id$  * @author<A HREF="mailto:m.dahm@gmx.de">M. Dahm</A>  */
end_comment
